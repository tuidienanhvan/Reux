// src/pages/AuthPages/VerifyEmailPage.jsx
...
// Component trang xác minh email với UX và accessibility tối ưu
export default function VerifyEmailPage() {
  ...
  // Xử lý xác minh email khi trang tải
  useEffect(() => {
      ...
      try {
        ...
        setFormStatus({
          ...
          message:
            ...
            err.message ||
            "Server error during email verification. Please try again later.",
        });
      } finally {
        setIsLoading(false);
      }
      ...
      <div className="w-full max-w-md bg-base-100 rounded-xl shadow-md p-4 sm:p-6 md:p-8 hover:shadow-lg transition-all duration-300 z-10">
        ...
        {isLoading ? (
          <div className="flex justify-center items-center">
            ...
            <span className="ml-2 text-base-content font-texas">Verifying...</span>
          </div>
        ) : (
          <p className="text-center text-base-content font-texas">
            {formStatus ? formStatus.message : "Processing email verification..."}
          </p>
        )}
      </div>
